...
class IMomoError(Exception):
    ...
    def __init__(self, details=None, error_code=None):
        super(IMomoError, self).__init__(details)
...
class FirstDischargeModelDeleteError(IMomoError):
    ...
    details = ("Discharge model can't be deleted because it's the first "
                "discharge model for the site.")
...
class NoFittingDischargeModelError(DischargeModelsError):
    ...
    DischargeModelsError._add_error_code('15001',
                                         'NoFittingDischargeModelError')
...
class RequiredParameterError(ValidationError):
    ...
    def __init__(self, parameter_name, to_camel=True, **kwargs):
        ...
        message = 'Parameter "{}" is required.'.format(parameter_name)
        super(RequiredParameterError, self).__init__(message, **kwargs)
