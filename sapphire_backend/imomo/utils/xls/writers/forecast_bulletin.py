...
class ForecastBulletinWriter(xlsxwriter.Workbook):
    ...
    headers = (
        {"header": "Site Name", "value_key": "site_name", "format": {}, "width": 30},
        {"header": "Site Code", "value_key": "site_code", "format": {}},
        {"header": "Model Name", "value_key": "model_name", "format": {}, "width": 30},
        {"header": "Issue Date", "value_key": "issue_date", "format": date_format, "date": True, "width": 15},
        {"header": "Period start", "value_key": "period_start", "format": date_format, "date": True, "width": 15},
        {"header": "Period end", "value_key": "period_end", "format": date_format, "date": True, "width": 15},
        {"header": "Forecasted Value", "value_key": "forecast_value", "format": {}, "hydrology_format": True},
        {"header": "Previous Value", "value_key": "previous_value", "format": {}, "hydrology_format": True},
        {"header": "Number of training data", "value_key": "n_of_data", "format": int_number},
        {"header": "P%", "value_key": "percentage", "format": float_number, "width": 6},
        {"header": "S/s", "value_key": "rel_error", "format": float_number, "width": 6},
        # {'header': u'±d', 'value_key': 'std_dev', 'format': float_number, 'width': 6},
        {"header": "Max", "value_key": "max", "format": {}, "width": 6, "hydrology_format": True},
        {"header": "Norm", "value_key": "norm", "format": {}, "width": 6, "hydrology_format": True},
        {"header": "Min", "value_key": "min", "format": {}, "width": 6, "hydrology_format": True},
    )
        ...
        for forecast_type in sorted_keys:
            ...
            for site, site_results in forecast_type_data.iteritems():
                ...
                if site_results and not forecast_type_header:
                    forecast_type_header = f"{forecast_type.name} ({forecast_type.frequency})"

                    worksheet.merge_range(
                        row, 0, row, len(self.headers) - 1, forecast_type_header, self._column_header_format
                    )
                ...
                for result in site_results:
                    model_name = result.forecast_training.forecast_model.name if result.forecast_training else "--"
